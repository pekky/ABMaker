...
from utils.smart_pdf_extractor import SmartPDFExtractor
...
def main():
    parser = argparse.ArgumentParser(description="快速小批次PDF转有声读物（单线程版本）")
